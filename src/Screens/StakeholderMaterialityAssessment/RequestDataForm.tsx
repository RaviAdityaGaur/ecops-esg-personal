...
const RequestDataForm: React.FC = () => {
    ...
    useEffect(() => {
        console.log('RequestDataForm loaded with:', { taskId, templateId });
    }, [taskId, templateId]);

    const handleBack = () => navigate(-1);
    const handleSaveAsDraft = () => console.log('Saving as draft...');
    const handleSubmit = () => console.log('Submitting request...');
            ...
            <Box sx={{ width: '100%', p: 3, bgcolor: '#f7f8fc' }}>
                ...
                <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 3, px: 1 }}>
                    ...
                    <Box sx={{ display: 'flex', gap: 2, alignItems: 'center' }}>
                        <Button variant="text" sx={{ textTransform: 'none', color: 'text.primary', fontWeight: 600 }}>Customise Template</Button>
                ...
                <Grid container spacing={3}>
                    ...
                    <Grid item xs={12}>
                        <Box sx={{ display: 'flex', gap: 2, justifyContent: 'flex-end', mt: 2 }}>
                            ...
                            <Button variant="contained" onClick={handleSubmit} sx={{ textTransform: 'none', bgcolor: '#147C65', '&:hover': { bgcolor: '#0f5a4a' } }}>Send Request</Button>
                        </Box>
                    </Grid>
                </Grid>
            </Box>
