...
import { Box, CssBaseline, Grid, ThemeProvider, Typography, Snackbar, Alert, IconButton, Collapse, Tooltip } from '@mui/material';
    ...
    <Box display="flex" justifyContent="center" alignItems="center" gap={1}>
      ...
      {title?.toUpperCase().includes('GRI') || title?.toUpperCase().includes('SASB') ? (
        <Tooltip title={
          ...
          <Box component="img" src={PopIcon} sx={{ width: 20, height: 20, cursor: 'help' }} />
        </Tooltip>
      ) : null}
    </Box>
    {subtitle && (
