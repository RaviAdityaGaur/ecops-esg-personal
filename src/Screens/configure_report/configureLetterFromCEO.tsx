...
const ConfigureLetterFromCEO: React.FC = () => {
      ...
      <Box sx={{ py: 1 }}>
         <Box sx={{  justifyContent: 'space-between', backgroundColor:'white',alignItems: 'center', mb: 3 }}>
                        <Typography variant="h6" sx={{ mb: 3, backgroundColor: 'white', p:2, borderRadius: 2 }}>
                          Overview - A Letter from Our Chief Executive Officer
                        </Typography>
        ...
        <Paper sx={{ p: 4, mx: 'auto' }}>
          <Grid container spacing={3}>
            ...
            <Grid item xs={12}>
              ...
              <TextField
                fullWidth
                placeholder="A Letter from Our Chief Executive Officer"
                value={title}
...
export default ConfigureLetterFromCEO;
