...
const ConfigureGovernanceStackholderEngagementAndTransparency: React.FC = () => {
  ...
  const handleNext = () => {
    ...
    navigate('/configure-report/Governance-Material-Topics');
  };
      ...
      <Box sx={{ py: 1 }}>
        <Box sx={{ justifyContent: 'space-between', backgroundColor: 'white', alignItems: 'center', mb: 3 }}>
          <Typography variant="h6" sx={{ mb: 3, backgroundColor: 'white', p: 2, borderRadius: 2 }}>
            Governance - Stackholder Engagement and Transparency
          </Typography>
        </Box>
...
export default ConfigureGovernanceStackholderEngagementAndTransparency;