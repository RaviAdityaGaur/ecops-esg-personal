...
const AppendixSustainabilityReportingTopicAssesment: React.FC = () => {
  ...
  const handleBack = () => {
    navigate('/configure-report/Appendix-Opening-Page');
  };
  const handleNext = () => {
    ...
    navigate('/configure-report/Appendix-End-Note');
  };
      ...
      <Box sx={{ py: 1 }}>
        <Box sx={{ justifyContent: 'space-between', backgroundColor: 'white', alignItems: 'center', mb: 3 }}>
          <Typography variant="h6" sx={{ mb: 3, backgroundColor: 'white', p: 2, borderRadius: 2 }}>
            Appendix - Sustainability Reporting Topic Assessment
          </Typography>
        </Box>
...
export default AppendixSustainabilityReportingTopicAssesment;