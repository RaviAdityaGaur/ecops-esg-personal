...
const AppendixSustainabilityEndNote: React.FC = () => {
  ...
  const handleBack = () => {
    navigate('/configure-report/Appendix-Sustainability-Reporting-Topic-Assesment');
  };
  const handleNext = () => {
    ...
    navigate('/configure-report/Appendix-Assurance-Statements');
  };
...
export default AppendixSustainabilityEndNote;