...
const ConfigureGovernanceEthicalBusinessConduct: React.FC = () => {
  ...
  const handleBack = () => {
    navigate('/configure-report/Governance-Corporate-Governance');
  };
  const handleNext = () => {
    ...
    navigate('/configure-report/Governance-Stackholder-Engagement-And-Transparency');
  };
      ...
      <Box sx={{ py: 1 }}>
        <Box sx={{ justifyContent: 'space-between', backgroundColor: 'white', alignItems: 'center', mb: 3 }}>
          <Typography variant="h6" sx={{ mb: 3, backgroundColor: 'white', p: 2, borderRadius: 2 }}>
            Governance - Ethical Business Conduct & Integrity
          </Typography>
        </Box>
...
export default ConfigureGovernanceEthicalBusinessConduct;