...
const ConfigureEnviromentalOpeningPage: React.FC = () => {
    ...
    // Navigate to Environment in Figures page
...
export default ConfigureEnviromentalOpeningPage;