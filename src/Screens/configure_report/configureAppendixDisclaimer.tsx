...
const AppendixDisclaimer: React.FC = () => {
  ...
  const handleNext = () => {
    ...
    navigate('/configure-report/Report-Closing-Page');
  };
      ...
      <Box sx={{ py: 1 }}>
        <Box sx={{ justifyContent: 'space-between', backgroundColor: 'white', alignItems: 'center', mb: 3 }}>
          <Typography variant="h6" sx={{ mb: 3, backgroundColor: 'white', p: 2, borderRadius: 2 }}>
                      Appendix - Disclaimer and Forward Looking
          </Typography>
        </Box>
...
export default AppendixDisclaimer;