...
const ConfigureGovernanceInFigures: React.FC = () => {
  ...
  const handleNext = () => {
    ...
    // Navigate to Social Responsibility page
      ...
      <Box sx={{ py: 1 }}>
        <Box sx={{ justifyContent: 'space-between', backgroundColor: 'white', alignItems: 'center', mb: 3 }}>
          <Typography variant="h6" sx={{ mb: 3, backgroundColor: 'white', p: 2, borderRadius: 2 }}>
                      Governance - Governance in Figures
          </Typography>
        </Box>
...
export default ConfigureGovernanceInFigures;